...
export async function initDatabase() {
  ...
  try {
    ...
    const testSystemMigrations = [
      ...
      `ALTER TABLE users ADD COLUMN IF NOT EXISTS test_1_attempt INTEGER DEFAULT 0`,
      ...
      `ALTER TABLE users ADD COLUMN IF NOT EXISTS test_2_attempt INTEGER DEFAULT 0`,
      ...
      `ALTER TABLE users ADD COLUMN IF NOT EXISTS test_3_attempt INTEGER DEFAULT 0`,
...
export async function deleteUser(telegramId) {
  ...
  // Update referral counts BEFORE deleting referrals (so subquery works)
  await pool.query(`
